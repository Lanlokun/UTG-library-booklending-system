    ...
    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <div class="flex items-center justify-center mt-8">
            <div class="flex items-center">
                ...
                <span class="text-white text-2xl mx-2 font-semibold">UTG Library Management System</span>
            </div>
        </div>
...
<!--            </Link>-->
            ...
            <Link class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                ...
                <span class="mx-3">Libraries</span>
            </Link>
            ...
            <Link class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                ...
                <span class="mx-3">Publishers</span>
            </Link>
...
<!--            </Link>-->
            ...
            <div class="px-6 ...">
                ...
                <hr style="width:100%;text-align:left;margin-left:0; opacity: 0.2; padding-bottom: 30px">

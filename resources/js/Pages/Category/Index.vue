            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <Link :href="route('admin.categories.create')" class="px-4 py-2 bg-green-600 hover:bg-green-800 text-white rounded-lg">Create Category </Link>
                    </div>
...
watch(search, value => {
    Inertia.get('/admin/categories', { search: value }, {preserveState: true, replace:true})
});

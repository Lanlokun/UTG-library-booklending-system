                    ...
                    <form @submit.prevent="form.post(route('admin.staff-attendance.store', staff.id))">
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <div class="error" v-if="errors.library">{{ errors.library }}</div>
                            ...
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <a :href="route('admin.staff-attendance.index', staff.id)" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none mx-5 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</a>

            ...
            <div class="max-w-7xl mx-auto">
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2">
                        ...
                        <Link :href="route('admin.staff-borrows.index', staff.id)" class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 mx-3 rounded-lg">View Staff Borrows </Link>
                    ...
                    <div class="w-full mb-8 p-6 overflow-hidden bg-white rounded-lg shadow-lg">
                        ...
                        <form @submit.prevent="submitStaffBorrow">
...
const form = useForm({
    book_copy_id: props.borrow_staff.book_copy_id,
    library_id: props.borrow_staff.library_id,
    date_borrowed: props.borrow_staff.date_borrowed,
    date_expected: props.borrow_staff.date_expected,
    date_returned: props.borrow_staff.date_returned,

})

function submitStaffBorrow()
{
    form.put(`/admin/staffs/${props.staff.id}/staff-borrows/${props.borrow_staff.id}`)
}

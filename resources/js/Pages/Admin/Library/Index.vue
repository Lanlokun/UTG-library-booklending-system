        ...
        <div class="my-35">
            <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
                <div class="block mb-8">
                    ...
                    <a href="/library/create" class="bg-blue-900 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Add Library</a>
                </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 w-full">
                                    ...
                                    <tr v-for="library in libraries">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <Link :href="route('library.show', library.id)" class="bg-blue-700 mx-5 hover:bg-blue-900 text-white px-4 py-2 rounded-l-lg">View </Link>
                                            <Link :href="route('library.edit', library.id)"  class="bg-green-700 mx-5 hover:bg-green-900 text-white px-4 py-2 rounded-l-lg ">Edit </Link>

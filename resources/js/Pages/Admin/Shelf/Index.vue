        ...
        <div class="my-35">
            <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
                <div class="block mb-8">
                    ...
                    <a href="/shelf/create" class="bg-blue-900 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Add Shelf</a>
                </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 w-full">
                                    ...
                                    <tr v-for="shelf in shelves">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <Link :href="route('shelf.show', shelf.id)" class="bg-blue-700 mx-5 hover:bg-blue-900 text-white px-4 py-2 rounded-l-lg">View </Link>
                                            <Link :href="route('shelf.edit', shelf.id)"  class="bg-green-700 mx-5 hover:bg-green-900 text-white px-4 py-2 rounded-l-lg ">Edit </Link>                                            <form class="inline-block mx-5" @submit.prevent="form.post(route('user.destroy'))" onsubmit="return confirm('Are you sure?');">

                    ...
                    <div class="w-full overflow-x-auto">
                        ...
                        <Table>
                            <template #tableHead>
                                ...
                                <TableHead>Place Of Pub</TableHead>
                            ...
                            <TableRow v-for="book in books.data" :key="book.id">
                                ...
                                <TableData>{{ book.author_1 }} {{ book.author_2 }}</TableData>
                                <TableData>{{ book.edition }}</TableData>
                                <TableData>{{ book.place_of_pub }}</TableData>
                                <TableData>{{ book.year }}</TableData>
                                <TableData>{{ book.isbn }}</TableData>
                                <TableData>{{ book.class_no }}</TableData>
                                <TableData>{{ book.more_details }}</TableData>
